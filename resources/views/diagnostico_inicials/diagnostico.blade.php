                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">DIAGNOSTICO INICIAL</h2>
                        </div>
                        <!-- /.card-header -->
                        {{ Form::open(['route' => ['diagnostico_inicials.diagnostico_estudiante', Auth::user()->id], 'method' => 'post', 'id' => 'formDiagnostico', 'files' => true]) }}
                        <div class="card-body">
