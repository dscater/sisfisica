 ...
 <div class="row">
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box">
            <span class="info-box-icon "  style=" background: url('imgs/Imagen1.jpg');background-size: cover;  "><i  ></i></span>
            <div >
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box">
            <span class="info-box-icon " style=" background: url('imgs/Imagen2.jpg');background-size: cover;  " ><i ></i></span>
    ...
    <div class="col-12 col-sm-6 col-md-3">
        <div class="info-box">
            <span class="info-box-icon bg-dange"  style=" background: url('imgs/Imagen3.jpg');background-size: cover;  "><i></i></span>
            <div  style="text-align:center">
                <span class="info-box-text">Puntuación extra</span>
                <span class="info-box-number"
                    style="font-size:1.4em;">{{ $puntaje_extra->puntaje }}</span>
            </div>
        </div>
    </div>
</div>
