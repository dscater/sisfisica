...
<head>
    ...
    {{-- SUMMER NOTE --}}
    <link rel="stylesheet" href="{{ asset('template/AdminLTE-3.0.5/plugins/summernote/summernote.css') }}">

    {{-- DROPZONE --}}
    <link rel="stylesheet" href="{{asset('dropzone/dist/dropzone.css')}}">

    {{-- unitegallery-master --}}
    <link rel="stylesheet" href="{{asset('unitegallery-master/dist/css/unite-gallery.css')}}">
    <link href="{{asset('unitegallery-master/dist/themes/default/ug-theme-default.css')}}" rel="stylesheet">
    <link href="{{asset('unitegallery-master/dist/themes/video/skin-right-no-thumb.css')}}" rel="stylesheet">

    {{-- JQUERY UI --}}
    <link rel="stylesheet" href="{{ asset('template/AdminLTE-3.0.5/plugins/jquery-ui/jquery-ui.css') }}"">
...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed control-sidebar-slide-open text-sm">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4">
            ...
            <a href="{{ route('home') }}" class="brand-link" style="color:black!important;">
                ...
                <span class="brand-text text-white">SISFISICA</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} SISFISICA</strong>
            Todos los derechos reservados.
            <div class="float-right d-none d-sm-inline-block">
                <b>Version</b> 1.0.0
            </div>
        </footer>
        <input type="hidden" id="public_path" value="{{asset('audio')}}/">
        {{-- <audio src="{{asset('audio/lvl.m4a')}}" id="audio_partida" autoplay class="hidden"></audio> --}}
    </div>
    <!-- ./wrapper -->
    ...
    <script src="{{ asset('template/AdminLTE-3.0.5/plugins/jquery-ui/jquery-ui.js') }}"></script>
    <!-- Bootstrap -->
    ...
    {{-- unitegallery-master --}}
    <script src="{{asset('unitegallery-master/dist/js/unitegallery.js')}}"></script>
    <script src="{{asset('unitegallery-master/dist/themes/default/ug-theme-default.js')}}"></script>
    <script src="{{asset('unitegallery-master/dist/themes/video/ug-theme-video.js')}}"></script>
    ...
    {{-- SUMMER NOTE --}}
    <script src="{{ asset('template/AdminLTE-3.0.5/plugins/summernote/summernote.js') }}"></script>
