                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row" id="contenedor_principal2">
                                <div class="col-md-6">
                                    <h4>Despejar la aceleración <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen4.jpg') }}"
                                    ...
                                    <ul id="contenedor_imgs2" class="contenedor_imgs" style="margin-top:10px;">
                                        <li class="imagen AX ui-state-default">
                                            <div class="img" data-img="Imagen4.jpg">
                                                <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen4.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen AX ui-state-default">
                                            <div class="img" data-img="Imagen3.jpg">
                                                <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen3.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen AX ui-state-default">
                                            <div class="img" data-img="Imagen7.jpg">
                                                <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen7.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen AX ui-state-default">
                                            <div class="img" data-img="Imagen2.jpg">
                                                <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen2.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen AX ui-state-default">
                                            <div class="img" data-img="Imagen5.jpg">
                                                <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen5.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contenedor_pasos1" id="contenedor_pasos2">
                                        <div class="el1 AX" data-id="1"></div> =
                                        <div class="el2">
                                            <div class="el3">
                                                <div class="el5 AX" data-id="2"></div>
                                                <div class="el6 AX" data-id="3"></div>
                                                <div class="el7 AX" data-id="4"></div>
                                            </div>
                                            <div class="el4 AX" data-id="5"></div>
                                        </div>
                                    </div>
                                    <div class="alert mensaje_info oculto mt-5"></div>
                                    <button type="button" class="btn btn-info btnRevisarAX"><i
                                            class="fa fa- clipboard-check"></i> REVISAR</button>
                                    <button type="button" class="btn btn-default btnReiniciaAX"><i
                            ...
                            <div class="row" id="contenedor_principal3">
                                <div class="col-md-6">
                                    <h4>Despejar el tiempo <img src="{{ asset('imgs/formulas/3__Movimiento_en_plano/formula 1/Imagen5.jpg') }}"
                                            style="width:90px;"> <br> <small>Arrastra las imagenes donde crees que correspondan</small></h4>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('.btnRevisarAX').click(function() {
                let boton = $(this);
                let sw = false;
                let imgs = $('#contenedor_pasos2').find('.AX');
                imgs.each(function() {
                    let img = $(this).children('.img');
                    let id = $(this).attr('data-id');
                    if (img.length > 0) {
                        console.log(img.attr('data-img'));
                        console.log(solucionAX[id]);
                        console.log('-----------------------------------------');
                        if (img.attr('data-img') == solucionAX[id]) {
                            sw = true;
                        } else {
                            sw = false;
                            return false;
            ...
            $('.btnReiniciaAX').click(function() {
                let imgs = $('#contenedor_pasos2').find('.AX');
                imgs.each(function() {
                    if ($(this).children('.img').length > 0) {
                        let elemento_rest =
                            `<li class="imagen AX ui-state-default">${$(this).html()}</li>`;
