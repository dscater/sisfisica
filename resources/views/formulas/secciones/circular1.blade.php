                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row" id="contenedor_principal1">
                                <div class="col-md-6">
                                    <h4>Despejar la velocidad inicial <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen2.jpg') }}"
                                    ...
                                    <ul id="contenedor_imgs" class="contenedor_imgs" style="margin-top:10px;">
                                        <li class="imagen VI ui-state-default">
                                            <div class="img" data-img="Imagen2.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen2.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen VI ui-state-default">
                                            <div class="img" data-img="Imagen6.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen6.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen VI ui-state-default">
                                            <div class="img" data-img="Imagen7.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen7.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen VI ui-state-default">
                                            <div class="img" data-img="Imagen4.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen4.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                        <li class="imagen VI ui-state-default">
                                            <div class="img" data-img="Imagen5.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen5.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contenedor_pasos1" id="contenedor_pasos1">
                                        ...
                                        <div class="el2 VI" data-id="2"></div>
                                        <div class="el3 VI" data-id="3"></div>
                                        <div class="el5 VI" data-id="4"></div>
                                        <div class="el6 VI" data-id="5"></div>
                                    </div>
                            ...
                            <div class="row" id="contenedor_principal2">
                                <div class="col-md-6">
                                    <h4>Despejar la aceleración angular <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen4.jpg') }}"
                                            style="width:90px;"> <br> <small>Arrastra las imagenes donde crees que correspondan</small></h4>
                                    <ul id="contenedor_imgs2" class="contenedor_imgs" style="margin-top:10px;">
                                        <li class="imagen AA ui-state-default">
                                            <div class="img" data-img="Imagen4.jpg">
                                                <img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen4.jpg') }}"
                                                    alt="Imagen">
                                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contenedor_pasos1" id="contenedor_pasos2">
                                        <div class="el1 AA" data-id="1"></div> =
                                        <div class="el2">
                                            <div class="el3">
                                                <div class="el5 AA" data-id="2"></div>
                                                <div class="el6 AA" data-id="3"></div>
                                                <div class="el7 AA" data-id="4"></div>
                                            </div>
                                            <div class="el4 AA" data-id="5"></div>
                                        </div>
                                    </div>
                                    <div class="alert mensaje_info oculto mt-5"></div>
                                    <button type="button" class="btn btn-info btnRevisarAA"><i
                                            class="fa fa- clipboard-check"></i> REVISAR</button>
                                    <button type="button" class="btn btn-default btnReiniciaAA"><i
                                            class="fa fa- clipboard-check"></i> REINICIAR</button>
                                </div>
                            </div>
                            ...
                            <div class="row" id="contenedor_principal3">
                                <div class="col-md-6">
                                    <h4>Despejar el tiempo<img src="{{ asset('imgs/formulas/6__Movimiento_circular/formula 1/Imagen5.jpg') }}"
                                            style="width:90px;"> <br> <small>Arrastra las imagenes donde crees que correspondan</small></h4>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('.btnRevisarAA').click(function() {
                let boton = $(this);
                let sw = false;
                let imgs = $('#contenedor_pasos2').find('.AA');
                imgs.each(function() {
                    let img = $(this).children('.img');
                    let id = $(this).attr('data-id');
                    if (img.length > 0) {
                        console.log(img.attr('data-img'));
                        console.log(solucionAA[id]);
                        console.log('-----------------------------------------');
                        if (img.attr('data-img') == solucionAA[id]) {
                            sw = true;
                        } else {
                            sw = false;
                            return false;
            ...
            $('.btnReiniciaAA').click(function() {
                let imgs = $('#contenedor_pasos2').find('.AA');
                imgs.each(function() {
                    if ($(this).children('.img').length > 0) {
                        let elemento_rest =
                            `<li class="imagen AA ui-state-default">${$(this).html()}</li>`;
            ...
            $('.btnRevisarDT').click(function() {
                let boton = $(this);
                let sw = false;
                let imgs = $('#contenedor_pasos3').find('.DT');
                imgs.each(function() {
                    let img = $(this).children('.img');
                    let id = $(this).attr('data-id');
                    if (img.length > 0) {
